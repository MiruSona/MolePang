...
public class DifficultBtn : MonoBehaviour {
    ...
    private void StartGame()
    {
        switch (difficult)
        {
            case Difficult.Easy: system_manager.StartEasy(); break;
            case Difficult.Normal: system_manager.StartNormal(); break;
            case Difficult.Hard: system_manager.StartHard(); break;
        }
